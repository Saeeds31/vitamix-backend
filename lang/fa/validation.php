...
return [
    ...
    'attributes' => [
        ...
        'brochure_id' => 'جزوه',
        'icon' => 'آیکن',
        'allow_to_exam' => 'اجازه آزمون',
        'cost' => 'قیمت',
        'paid_cost' => 'مبلغ پرداخت شده',
        "pay_status" => 'وضعیت پرداخت',
        'debt_balance' => 'مانده بدهی',
        'score' => 'نمره',
        'false_count' => 'تعداد غلط',
        "accept_score" => 'نمره قبولی',
        'question_id' => 'سوال',
        'name' => 'نام',
        'subject' => 'موضوع',
        'body' => 'بدنه',
        ...
        "item_3" => 'گزینه سه',
        "item_4" => 'گزینه 4',
        "true_answer" => 'پاسخ درست',
        "step" => 'مرحله',
        "error_note" => 'پیغام خطا',
        "national_code" => 'کدملی',
        "birth_certificate_first_page" => 'صفحه اول شناسنامه',
        "birth_certificate_second_page" => 'صفحه دوم شناسنامه',
        "end_of_service" => 'پایان خدمت',
        "no_criminal_record" => 'سابقه کیفری',
        "non_addiction" => 'عدم اعتیاد',
        ...
        'eye_color' => 'رنگ چشم',
        'hair_color' => 'رنگ مو',
        'last_certificate' => 'آخرین مدرک',
        'career_history' => 'سوابق شغلی',
        'skills' => 'مهارت ها',
        'key' => 'کلید',
        'value' => 'مقدار',
        'type' => 'نوع',
